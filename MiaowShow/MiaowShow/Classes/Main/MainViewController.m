...
- (void)setup
{
    [self addChildViewController:[[HomeViewController alloc] init] imageNamed:@"toolbar_home" title:@"首页"];
    
    UIViewController *showTime = [[UIViewController alloc] init];
    showTime.view.backgroundColor = [UIColor whiteColor];
    [self addChildViewController:showTime imageNamed:@"toolbar_live" title:@"直播"];
    [self addChildViewController:[[ProfileController alloc] init] imageNamed:@"toolbar_me" title:@"个人中心"];
}
...
//    childController.tabBarItem.imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
    [childController.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName : KeyColor} forState:UIControlStateNormal];
