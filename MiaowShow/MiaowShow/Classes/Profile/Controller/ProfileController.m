...
- (void)setupHeaderView
{
    ...
    XLWaveView *wave = [[XLWaveView alloc] initWithFrame:CGRectMake(0, -60, ALinScreenWidth, 270) Image:@"Cyuri03" centerIcon:@"icon"];
    self.waveView = wave;
    ...
    // 与图像高度一样防止数据被遮挡
    self.tableView.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ALinScreenWidth , wave.height)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (offsetY < 0) {
        ...
        self.waveView.frame = CGRectMake(offsetY/2, offsetY, ALinScreenWidth - offsetY, 270 - offsetY);  // 修改头部的frame值就行了
    }
